...
const TopRated = () => {
    ...
    useEffect(function(){
        ...
        axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=03056f9e2e643ba4493005b6bf65ea06&with_original_language=hi&page=${page}`)
  ...
  return (
    <>
    <div className="mb-8">
          <div className="mt-3 mb-8 font-bold text-2xl text-center bg-black text-white"> Top Rated</div>
            {
            topRated.length===0 ?
